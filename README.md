...
2. 飲食店一覧画面(ホーム画面)で、「仙人」「牛助」「戦慄」のいずれかの「詳しく見る」ボタンをクリックして、飲食店詳細/新規予約画面に進んでください。

> 本アプリでStripeの決済機能を実行するには、「コースメニュー」が1つ以上登録されている飲食店で予約する必要があります。
> 「仙人」「牛助」「戦慄」の3店には、シーディングによりあらかじめコースメニューが登録されています。
> これら3店以外では、店舗代表者アカウントでログインしたのち、各飲食店の設定画面でコースメニューを登録しておく必要があります。
...
店舗代表者は担当の飲食店の情報を編集することができますが、登録済みの飲食店の場合は、事前に管理者が、その飲食店に店舗代表者を割り当てておく必要があります。以下に、管理者アカウントでログインし、対象の飲食店に店舗代表者を割り当てる方法を示します。
...
6. 【新規登録】新規の飲食店情報を作成する場合は、店舗代表者マイページにて「新規登録」をクリックしてください。新規店舗作成画面にて必要事項を記入のうえ「この内容で新規登録」をクリックしてください。
